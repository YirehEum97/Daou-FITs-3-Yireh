...
SELECT 
    NVL2(BRANCH_ID, (SELECT NAME FROM BRANCHES B WHERE B.BRANCH_ID = L.BRANCH_ID), 'All Branch') AS BRANCH_NAME,
...
SELECT
    COUNT(CASE WHEN STATUS='APPROVED' THEN 1 END)/COUNT(*)*100
FROM LOANS
;